...
void draw_rectangle(
    ...
    uint32_t color)
{
   printf("[graphics] draw_rectangle: "
          "argcnt=%i "
          "wndnum=%u "
          "x1=%i "
          "y1=%i "
...
void fill_rectangle(
    ...
    uint32_t color)
{
   printf("[graphics] fill_rectangle: "
          "argcnt=%i "
          "wndnum=%u "
          "x1=%i "
          "y1=%i "
...
void hash_rectangle(
    ...
    uint32_t color)
{
   printf("[graphics] hash_rectangle: "
          "argcnt=%i "
          "wndnum=%u "
          "x1=%i "
          "y1=%i "
    ...
    int16_t *array)
{
   ...
   printf("[graphics] visible_bitmap_rect: "
          "argcnt=%i "
          "x=%i "
          "y=%i "
          "flip=%u "
...
uint32_t read_palette(int32_t argcnt, uint32_t regnum)
{
   ...
   val = ((uint32_t)triplet.r << 12) |
         ((uint32_t)triplet.g << 6) |
         ((uint32_t)triplet.b);
    ...
    uint32_t y2)
{
   ...
   printf("[graphics] assign_subwindow: "
          "argcnt=%i "
          "owner=%u "
          "parent=%u "
          "x1=%u "
    ...
    int32_t max)
{
   ...
   printf("[graphics] solid_bar_graph: "
          "argcnt=%i "
          "x0=%i "
          "y0=%i "
          "x1=%i "
