...
extern "C"
{
   ...
   void cdecl AIL_format_VOC_file(HDRIVER driver, _Far void *VOC_sel, int block_marker);
...
unsigned cdecl AIL_index_VOC_block(HDRIVER driver, void far *VOC_sel,
                                   unsigned VOC_seg, unsigned block_marker, sound_buff *buff);
void cdecl AIL_format_VOC_file(HDRIVER driver, void far *VOC_sel, int block_marker);
